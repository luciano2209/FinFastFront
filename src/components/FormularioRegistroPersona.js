...
export default function FormularioRegistroPersona({abrirFormulario, setAbrirFormulario}) {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (formValue) => {
      try {
        ...
        await axios
          .post('https://localhost:44392/api/persona',_nuevoUsuario)
          .then(res => {
    ...
    <form className="mx-10 mt-5 space-y-8 divide-y divide-gray-200" onSubmit={formik.handleSubmit}>
      <div className="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div className="pt-8 space-y-6 sm:pt-10 sm:space-y-5">
          <div>
            <h3 className="text-lg leading-6 font-medium text-gray-900">Formularuo para registrar Personas</h3>
          </div> 
